...
class _AdminPanelState extends State<AdminPanel> {
  ...
  List kategoriRole = ['Semua', 'Guest', 'Mahasiswa Aktif', 'Fungsionaris', 'Alumni', 'Dosen', 'Admin', 'Developer'];
  int statusRole = 0;
  ...
  void getAllFilterUser({@required int role}) {
    Provider.of<AdminProvider>(context, listen: false).getAllFilterUser(role, token);
  }
              ...
              PageView(
                ...
                onPageChanged: (index) {
                  setState(() {
                    ...
                    if (index == 1) {
                      Provider.of<AdminProvider>(context, listen: false).getAllBug(token);
                    }
                    if (index == 2) {
                      Provider.of<AdminProvider>(context, listen: false).getAllFeedback(token);
                    }
                    if (index == 3) {
                      Provider.of<AdminProvider>(context, listen: false).getAllForm(token);
                    }
                    if (index == 4) {
                      Provider.of<AdminProvider>(context, listen: false).getAllKey(token);
                    }
                  });
                },
                children: <Widget>[
      ...
      child: NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification scrollInfo) {
          if (!isLoadingMore && scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent) {
            ...
            //load data
            Provider.of<AdminProvider>(context, listen: false).getAllBugMore(token);
          }
          return true;
        },
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: SafeArea(
                  child: Padding(
                    ...
                    child: Text('Daftar Laporan Bug', style: AppStyle.textHeadlineTipisBlack),
                  ),
                ),
      ...
      child: NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification scrollInfo) {
          if (!isLoadingMore && scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent) {
            ...
            //load data
            Provider.of<AdminProvider>(context, listen: false).getAllFeedbackMore(token);
          }
          return true;
        },
        child: CustomScrollView(
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: SafeArea(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 18.0),
                    child: Text('Daftar feedback', style: AppStyle.textHeadlineTipisBlack),
                  ),
                ),
                collapseMode: CollapseMode.parallax,
              ),
      ...
      child: NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification scrollInfo) {
          if (!isLoadingMore && scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent) {
            ...
            //load data
            Provider.of<AdminProvider>(context, listen: false).getAllFormMore(token);
          }
          return true;
        },
        child: CustomScrollView(
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                title: SafeArea(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 18.0),
                    child: Text('Daftar Request Invitation Key', style: AppStyle.textHeadlineTipisBlack),
                  ),
                ),
                collapseMode: CollapseMode.parallax,
              ),
                  ...
                  child: (isLoading)
                      ...
                      : InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(child: Text('Generate key', style: AppStyle.textSubHeading2Putih)),
                          ),
                        ),
                ),
              ),
    ...
    return SafeArea(
      ...
      onNotification: (ScrollNotification scrollInfo) {
        if (!isLoadingMore && scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent) {
          ...
          //load data
          (status == 0) ? Provider.of<AdminProvider>(context, listen: false).getAllUserMore(token) : Provider.of<AdminProvider>(context, listen: false).getAllFilterUserMore(status, token);
        }
        return true;
      },
      child: CustomScrollView(
          ...
          slivers: <Widget>[
                          ...
                          TextField(
                            ...
                            onSubmitted: (newValue) {
                              Navigator.of(context).push(
                                PageRouteBuilder(
                                  opaque: false,
                                  pageBuilder: (BuildContext context, _, __) => SearchUser(param: newValue, token: token),
                                ),
                              );
                            },
                          ),
            ...
            (allUser == null && status == 0 || allFilterUser == null && status != 0)
                ? SliverToBoxAdapter(
                    child: Center(
                      child: SizedBox(
                        height: 50.0,
