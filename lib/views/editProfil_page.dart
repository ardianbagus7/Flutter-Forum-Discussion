...
class EditProfil extends StatefulWidget {
  ...
  EditProfil({Key key, @required this.image, this.name, this.angkatan})
      : super(key: key);
  @override
  _EditProfilState createState() =>
      _EditProfilState(image: image, name: name, angkatan: angkatan);
}
...
class _EditProfilState extends State<EditProfil> {
  ...
  _EditProfilState({Key key, @required this.image, this.name, this.angkatan});
  ...
  Widget build(BuildContext context) {
    ...
    void submit() async {
      bool status = await Provider.of<PostProvider>(context, listen: false)
          .editProfil(titleController.text, descriptionController.text, _image);
      if (status) {
        Navigator.pushNamedAndRemoveUntil(
            context, '/home-page', (Route<dynamic> route) => false);

        await Provider.of<AuthProvider>(context, listen: false).reLogin();
      } else {
        setState(() {
