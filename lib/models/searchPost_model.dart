...
//
//     final searchPost = searchPostFromJson(jsonString);

import 'dart:convert';

SearchPost searchPostFromJson(String str) => SearchPost.fromJson(json.decode(str));

String searchPostToJson(SearchPost data) => json.encode(data.toJson());
